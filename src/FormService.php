...
class FormService
{
     ...
     * @return \NetoJose\Bootstrap4Forms\FormService
     */
    public function checkbox(string $name = null, string $label = null, string $value = null, string $default = null
    ): FormService {
     ...
     * @return \NetoJose\Bootstrap4Forms\FormService
     */
    public function radio(string $name = null, string $label = null, string $value = null, string $default = null
    ): FormService {
    ...
    private function _checkboxRadio($type, $name, $label, $value, $default): FormService
    {
        ...
        return $this->_set('meta', ['value' => $inputValue])
            ->type($type)
            ->name($name)
            ->label($label)
            ->value($default);
